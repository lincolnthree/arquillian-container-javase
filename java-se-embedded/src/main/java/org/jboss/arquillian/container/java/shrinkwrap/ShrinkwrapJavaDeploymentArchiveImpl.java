 ...
 */
package org.jboss.arquillian.container.java.shrinkwrap;
 ...
 * @version $Revision: $
 */
public class ShrinkwrapJavaDeploymentArchiveImpl implements ShrinkwrapJavaDeploymentArchive, Assignable
{
   ...
   public ShrinkwrapJavaDeploymentArchiveImpl(final Archive<?> archive)
   {
      ...
      for (final Map.Entry<ArchivePath, Node> entry : classes.entrySet())
      {
         try
         {
            beanClasses.add(
                     ...
                     {
                        @Override
                        protected java.net.URLConnection openConnection(final URL u) throws java.io.IOException
                        {
   ...
   /*
    * input: /org/MyClass.class output: org.MyClass
    */
   public String getClassName(final ArchivePath path)
   {
